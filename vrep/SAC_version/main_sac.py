...
def train():
    ...
    #------record memory------#
    step_set, reward_set, avg_reward_set, state_set ,action_set,joint2_set,joint3_set,joint5_set,distance_set= [], [], [], [], [], [], [], [], []
    ...
    file_name = ['step.txt', 'reward.txt', 'avgR.txt', 'joint2.txt','joint3.txt','joint5.txt','distance.txt','state_set.txt','action_set.txt']
    data_set = ['step_set', 'reward_set','avg_reward_set','joint2_set','joint3_set','joint5_set','distance_set','state_set','action_set']
    ...
    xlabel = ['Episode', 'Episode', 'Episode', 'Episode','Episode','Episode','Episode','Episode','Episode']
    ylabel = ['step', 'r', 'avgR','joint2','joint3','joint5','distance','state','action']
    title = ['step', 'reward', 'avgR','joint2','joint3','joint5','distance','state','action']
    for i in range(len(file_name)):
