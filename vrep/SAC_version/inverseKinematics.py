...
def calculateJ2J3(Ex, Ey, Ez, J1, DH_table):
    ...
    ans = (BC * BC + BE * BE - CE * CE) / (2 * BC * BE)
    ans=np.clip(ans, -1, 1)
    # try:
    angleCBE = math.acos(ans)
    # except ValueError:
    #     print('IK fail')
...
##這裡position單位是cm
    ...
    J2s[0], J2s[1], J3s[0], J3s[1] = calculateJ2J3(Ex, Ey, Ez, J1s[0], DH_table)
    J2s[2], J2s[3], J3s[2], J3s[3] = calculateJ2J3(Ex, Ey, Ez, J1s[1], DH_table)
